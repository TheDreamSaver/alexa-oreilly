...
const CaptureBirthdayIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const localMonth = Alexa.getSlotValue(handlerInput.requestEnvelope, 'month');
        const localYear = Alexa.getSlotValue(handlerInput.requestEnvelope, 'year');
        
        const speakOutput = `Now I know your birth date. It is ${localDay} ${localMonth} ${localYear}.`;
