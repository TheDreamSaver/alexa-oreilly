...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        const localYear = persistentAttributes.hasOwnProperty('year') ? persistentAttributes.year : 0;
        const localMonthID = persistentAttributes.hasOwnProperty('month') ? persistentAttributes.month : 0;
        const localMonthName = persistentAttributes.hasOwnProperty('monthName') ? persistentAttributes.monthName : 0;
        const localDay = persistentAttributes.hasOwnProperty('day') ? persistentAttributes.day : 0;

        
        let speakOutput;

        if (localYear && localMonthID && localDay) {

            let birthdayData = getBirthdayData(localDay, localMonthID, localYear);
            console.log(birthdayData);

            speakOutput = `I already know your birthdate. It is ${localDay} ${localMonthName} ${localYear}.`;
            ...
            speakOutput = 'Welcome to Cake Time. What is your birth date?';
